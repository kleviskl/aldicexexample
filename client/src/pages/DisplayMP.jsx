...
const DisplayMP = () => {
  ...
  const getPicks = (csvData) => {
    ...
    let time = new Date().toLocaleTimeString();
      const spamStartTime = document.getElementById('startat');
      spamStartTime.innerText=time
      spamStartTime.classList.remove("invisible");
  };
  return (
    <>
        ...
        <div className="py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="space-y-6 lg:col-start-1 lg:col-span-2">
              <h2 className="text-2xl font-bold text-center">ALDIC Zone M/P</h2>
              <section aria-labelledby="cluster-number">
              <div id="version" className="float-right"><p className="text-indigo-600 font-medium italic md:text-base">Version 1.0</p></div>
